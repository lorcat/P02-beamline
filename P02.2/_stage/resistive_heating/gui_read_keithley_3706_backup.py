...
class ThreadMeasure(QThread):
    ...
    # check channels measured values - if too large - set to -1
...
class ThreadWriter(QThread):
    ...
    def writeFile(self):
        ...
        self.filestream.flush()         # necessary, otherwise no save
...
class TCGraph(QMainWindow):
    ...
    def initUI(self):
        ...
        wdgtlay.setColumnStretch(2, 50)
        
        templay.addWidget(wdgt, 1, 0)
        templay.setRowStretch(0, 50)
